...
function fp_rac_extract_cart_details($each_cart) {
    ...
    <tfoot>
        <tr>
            <?php $i = 1; ?>
            <th class="td" scope="row" colspan="3" style="text-align:left; <?php if ($i == 1) echo 'border-top-width: 4px;'; ?>"><?php echo fp_get_wpml_text('rac_template_subtotal', $each_cart->wpml_lang, get_option('rac_product_info_subtotal')); ?></th>
            <td class="td" style="text-align:left; <?php if ($i == 1) echo 'border-top-width: 4px;'; ?>"><?php echo FP_List_Table_RAC::format_price($subtotal); ?></td>
        </tr>
        <?php if($tax > 0){ ?>
        <tr>
            <?php $i = 1;
...
//            }
            ?>
            <th class="td" scope="row" colspan="3" style="text-align:left; <?php if ($i == 1) echo 'border-top-width: 4px;'; ?>"><?php echo fp_get_wpml_text('rac_template_tax', $each_cart->wpml_lang, get_option('rac_product_info_tax')); ?></th>
            <td class="td" style="text-align:left; <?php if ($i == 1) echo 'border-top-width: 4px;'; ?>"><?php echo FP_List_Table_RAC::format_price($tax); ?></td>
        </tr>
        <?php } ?>
        <tr>
            <?php $i = 1; ?>
            <th class="td" scope="row" colspan="3" style="text-align:left; <?php if ($i == 1) echo 'border-top-width: 4px;'; ?>"><?php echo fp_get_wpml_text('rac_template_total', $each_cart->wpml_lang, get_option('rac_product_info_total')); ?></th>
            <td class="td" style="text-align:left; <?php if ($i == 1) echo 'border-top-width: 4px;'; ?>"><?php echo FP_List_Table_RAC::format_price($subtotal+$tax); ?></td>
        </tr>
