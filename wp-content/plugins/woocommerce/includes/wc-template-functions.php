...
/********************************Woocommerce Custom Upsell Display function to add to cart directly************************************/
if ( ! function_exists( 'woocommerce_custom_upsell_display' ) ) 
{
	 ...
	 * @param string $orderby (default: 'rand')
	 */
	function woocommerce_custom_upsell_display( $posts_per_page = '-1', $columns = 4, $orderby = 'rand' ) 
	{
		wc_get_template( 'single-product/custom_up_sells.php', array(
				'posts_per_page'	=> $posts_per_page,
				'orderby'			=> apply_filters( 'woocommerce_upsells_orderby', $orderby ),
				'columns'			=> $columns
			) );
