	...
	function wcds_render_customers_table()
	{
		...
		jQuery.each(wcds_customers_data,function(index, customer)
		{
			...
			jQuery('#wcds_customers_table_body').append("<tr>"+
															...
															"<td>"+customer.total_spent+wcds_customers_currency+"</td>"+
														"</tr>");
		...
		jQuery('#wcds_customers_foot_total_spent').html(parseFloat(total_spent).toFixed(2)+wcds_customers_currency);
